...
<input type="hidden" value="${tea.tea_no}" id="access_tea_no"/> 	
    	  ...
    	  $("#btlogin").click(function(){
    		 ...
    		 /*  if(checkChecked()==false){
        		 ...
        		 $.ajax({
        				type:"post",
        				dataType:"json",
        				data:{"tea_no":$("#tea_no").val(),"access_tea_no":$("#access_tea_no").val(),"answer":chkVal.join(","),"advise": $editor.editor('getContent')},
        				url:"/save/AcessSameFieled/Teacher/Answer",
        				async:true,
