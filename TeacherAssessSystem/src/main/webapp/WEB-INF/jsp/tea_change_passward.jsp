...
<body>
  <div class="demo-content">
    <input id="teaNo" type="hidden" value="${tea_no}"/>
    <div class="row">
	 ...
	 $("#newPassward1").focus(function(){
		 debugger
			$.ajax({
				type:"post",
				dataType:"json",
				data:{"tea_no":$("#teaNo").val(),"passward":$("#oldPassward").val()},
				url:"/check_teaPassward",
	...
	$("#newPassward2").blur(function(){
 	...
 	var  checkPass =function(){
		...
		$.ajax({
			type:"post",
			dataType:"json",
			data:{"tea_no":$("#teaNo").val().trim(),"passward":$("#oldPassward").val().trim()},
			url:"/check_teaPassward",
			async:false,
			success:function(data){
				debugger
	 ...
	 $("#submit").click(function(){
		 ...
		 if(flag){
			 ...
			 $.ajax({
					type:"post",
					dataType:"json",
					data:{"tea_no":$("#teaNo").val(),"newPassward":$("#newPassward1").val()},
					url:"/tea_changePass",
					async:true,
					success:function(data){
						if(data.status == 0){
